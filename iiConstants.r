...
PENDING_ARCHIVE_REQUEST = "PENDING_ARCHIVE_REQUEST";
ARCHIVED = "ARCHIVED";
...
IIVAULTTRANSITIONS = list((UNPUBLISHED, SUBMITTED_FOR_PUBLICATION),
			  ...
			  (PENDING_REPUBLICATION, PUBLISHED),
		          (PUBLISHED, ARCHIVE_REQUEST),
			  (ARCHIVE_REQUEST, PENDING_ARCHIVE_REQUEST),
			  (PENDING_ARCHIVE_REQUEST, ARCHIVED),
			  (ARCHIVE_REQUEST, PUBLISHED),
			  (PENDING_ARCHIVE_REQUEST, PUBLISHED))
