...
def doSwordit(callback, bagitFile):
    ...
    c = Connection(SD_URI, user_name = "yodatest", user_pass="y$6]AQ5$BZ\Z", http_impl = http_impl)
    ...
    with open(bagitFile, "r") as pkg:
        ...
        #c2 = Connection(statementURI, user_name = "yodatest", user_pass="y$6]AQ5$BZ\Z", http_impl = http_impl)
