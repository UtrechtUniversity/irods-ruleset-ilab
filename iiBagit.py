...
#\[in]   rule_args[0] vaultPackage
#\[out]  rule_args[1] bagitPath
#\[out]  rule_args[2] status

def iiRuleBagit(rule_args, callback, rei):
    packagePath = rule_args[0]


#\ Brief create a bagit, a tar file conform the bagit standard

#\[in]   rule_args[0] bagitPath
#\[out]  rule_args[1] url
#\[out]  rule_args[2] status

def iiRuleSword2(rule_args, callback, rei):
    bagitPath = rule_args[0]
...
def doBagit(rule_args, callback, rei):
